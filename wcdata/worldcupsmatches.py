import sqlite3
conn = sqlite3.connect("worldcupsmatches.db")

cur = conn.cursor()

cur.execute('''CREATE TABLE worldcupsmatches (year text, date_txt text,  stage text,  stadium text,  city text,  hometeam text,
...
with open("WorldCupMatches.csv") as file:
    ...
    for line in file:
        ...
        cur.execute('''INSERT INTO worldcupsmatches VALUES({},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{})'''.format('"'+line[0]+'"',"'"+line[1]+"'",
